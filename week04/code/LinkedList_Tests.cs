...
public class ReverseTests
{
    ...
    {
        var ll = new LinkedList();
        Assert.AreEqual("<IEnumerable>{}", ll.Reverse().ToString());
    }
    ...
    public void Reverse_Single()
    {
        var ll = new LinkedList();
        ll.InsertHead(5);
        Assert.AreEqual("<IEnumerable>{5}", ll.Reverse().ToString());
    }
    ...
    public void Reverse_Basic()
    {
        ...
        ll.InsertHead(2);
        ll.InsertHead(5);
        Assert.AreEqual("<IEnumerable>{2, 2, 3, 4, 2, 5}", ll.Reverse().ToString());
    }
}